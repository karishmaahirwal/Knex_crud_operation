var knex=require("../model/database.js")
...
const post_data=(req,res)=>{
    ...
    knex(project2).insert(data).then(()=>{
        a=fs.writeFileSync("data.js",JSON.stringify(data,null,3))
        // res.send{message:"data post sucessfully"}
        console.log("Data intserted")
    }).catch((err)=>{
        console.log("Data doesn't inserted")
    })
}
...
module.exports={get_method,post_data,putdata, delete_data}
